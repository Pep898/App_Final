...
public class VisualitzarRutesSimples extends AppCompatActivity implements LocationListener,
        OnMapReadyCallback, PermissionsListener, MapboxMap.OnMapClickListener {
    private PermissionsManager permissionsManager;
    private MapboxMap mapboxMap;

    private MapView mapViewVisualitzar;
    Context context;
    private LocationManager locationManager;
    private Location location;

    private Button btnComençarRutaVisualitzar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.visualitzar_rutes_simples);
        context=getApplicationContext();

       //obte la ID de al ruta seleccioanda a traves del intent
        rutaID= getIntent().getStringExtra("RutaID");

        mapViewVisualitzar = findViewById(R.id.mapViewVisualitzar);
        btnComençarRutaVisualitzar = findViewById(R.id.btnComençarRutaVisualitzar);
        mapViewVisualitzar.onCreate(savedInstanceState);
        mapViewVisualitzar.getMapAsync(this);
        ...
        //começa a tracar al ruta
        btnComençarRutaVisualitzar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                NavigationLauncherOptions options = NavigationLauncherOptions.builder()
                        ...
                        .build();
                NavigationLauncher.startNavigation(VisualitzarRutesSimples.this,options);
            }
        });
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        VisualitzarRutesSimples.this.mapboxMap = mapboxMap;
    ...
    protected void onStart() {
        super.onStart();
        mapViewVisualitzar.onStart();
    }

    @Override
    protected void onResume() {
        super.onResume();
        mapViewVisualitzar.onResume();
    }

    @Override
    protected void onPause() {
        super.onPause();
        mapViewVisualitzar.onPause();
    }

    @Override
    protected void onStop() {
        super.onStop();
        mapViewVisualitzar.onStop();
    }

    @Override
    protected void onSaveInstanceState(Bundle outState) {
        super.onSaveInstanceState(outState);
        mapViewVisualitzar.onSaveInstanceState(outState);
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        mapViewVisualitzar.onDestroy();
    }

    @Override
    public void onLowMemory() {
        super.onLowMemory();
        mapViewVisualitzar.onLowMemory();
    }
                ...
                .getRoute(new Callback<DirectionsResponse>() {
                    ...
                    public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                        ...
                        if(navigationMapRoute!=null){
                            ...
                            navigationMapRoute= new NavigationMapRoute(null,mapViewVisualitzar,mapboxMap);
                        }
